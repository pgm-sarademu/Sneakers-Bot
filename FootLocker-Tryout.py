...
def URLGen(model, sku):
	URL = "https://www.footlocker.be/nl/product/model:" + str(model) +"/sku:" + str(sku)
	return URL

def URLFind(product, colorway):
	browser = webdriver.Chrome() 
	browser.get("https://www.footlocker.be/nl/release-dates/")
...
def run_bot(event):
	...
	time.sleep(1)
	site.get('https://www.footlocker.be/nl/shoppingcart')
